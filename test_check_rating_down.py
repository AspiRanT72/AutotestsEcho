...
browser.get(link)
rating = browser.find_elements(By.CLASS_NAME, 'inline-md-block.cursor-pointer.l-sort__item.q-mr-xs.q-mr-lg-sm')[1]
rating.click()
time.sleep(2)
rating.click()
time.sleep(2)
...
print(x1, x2, x3, i)
if x1 <= x2 <= x3 <= i:
    print('Рейтинг от меньшего к большему считается корректно')
else:
